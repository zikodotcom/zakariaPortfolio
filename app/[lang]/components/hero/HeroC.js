...
export default function HeroC({hero}) {
  return (
    <section id="home" className='hero h-[100vh] flex items-center'>
        <div className='w-full flex flex-col justify-end items-center'>
            ...
            <button className='bg-purple-600 p-4 border text-white rounded-lg hover:bg-transparent hover:border-purple-700 hover:text-purple-700'>{hero.cv}</button>
        </div>
    </section>
  )
}
